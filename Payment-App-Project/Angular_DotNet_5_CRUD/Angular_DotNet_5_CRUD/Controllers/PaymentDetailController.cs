...
namespace Angular_DotNet_5_CRUD.Controllers
{
    ...
    public class PaymentDetailController : ControllerBase
    {
        ...
        public async Task<ActionResult<PaymentDetail>> PostPaymentDetail(PaymentDetail paymentDetail)
        {
            ...
            return CreatedAtAction(nameof(GetPaymentDetail), new { id = paymentDetail.PaymentDetaiId }, paymentDetail);
        ...
        {
            if (id != paymentDetail.PaymentDetaiId)
            {
                return BadRequest();
            }
        ...
        {
            return _context.PaymentDetails.Any(x => x.PaymentDetaiId == id);
        }
    }
}
